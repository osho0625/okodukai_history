...
| `board-games.md` | `*cockroach*,*quarto*,*quoridor*,*memory-game*,*blokus*,*kotoba-otoshi*,*word-wolf*` を開いた時 | ごきぶりポーカー・クアルト・コリドール・神経衰弱・ブロックス・ことば落とし・ワードウルフ |
...
| `family-broadcast.md` | `*broadcast*,*raspi*,*video-call*` ファイルを開いた時 | おうちブロードキャスト（ラズパイ読み上げ）+ おうちビデオ通話（WebRTC） |
...
| 脱毛周期管理 | pages/hair-removal-tracker.html | Body Map（前面15/背面13ゾーン）・タップ情報表示＋記録モード（複数部位を選択して一括記録）・ヒートマップ・施術記録・統計・写真管理 |
