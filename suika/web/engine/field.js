  ...
  _drawAllSorted() {
    ...
    if (this.area && this.area.npcs) {
      const CChrPrm = [
        ...
        [41,0],[42,0],[46,0],[47,0],[48,0],[49,0],[50,0],[47,0],[51,0],[53,0],
        [54,0],[8,0],[55,0],[3,0],[5,0],[54,0],[41,0],[42,0],[42,0],[42,0],
        [42,0],[56,0],[39,0],[57,0],[-22,0],[37,0],[4,0],[59,0],[57,0],[60,0],
        [60,0],[5,0],[2,0],[61,0],[63,0],[64,0],[66,0],[68,0],[0,0],[47,0],
        [47,0],[71,0],[39,0],[7,0],[7,0],[71,0],[72,0],[74,0],[75,0],[76,0],
        [77,0],[78,0],[13,0],[80,0],[79,0],[81,0],[82,0],[-24,0],[7,0],[80,0],
        [84,0],[10,0],[41,0],[54,0],[85,0],[53,0],[86,0],[51,0],[85,0],[87,0],
        [88,0],[92,0],[-7,0],[60,0],[60,0],[93,0],[56,0],[85,0],[-29,0],[84,0],
        [84,0],[95,0],[96,0],[97,0],[98,0],[98,0],[99,0],[100,0],[100,0],[55,0],
        [101,0],[102,0],[103,0],[101,0],[103,0],[103,0],[104,0],[105,0],[2,0],[98,0],
        [4,0],[3,0],[85,0],[13,0],[101,0],[5,0],[84,0],[57,0],[63,0],[106,0],
        [76,0],[107,0],[107,0],[54,0],[50,0],[108,0],[99,0],[15,0],[97,0],[109,0],
        [110,0],[-27,0],[99,0],[110,0],[121,0],[42,0],[42,0],[42,0],[63,0],[42,0],
        [42,0],[110,0],[41,0],[6,0],[122,0],[83,0],[71,0],[123,0],[123,0],[124,0],
        [-34,0],[-25,0],[127,0],[128,0],[129,0],[130,0],[131,0],[132,0],[2,0],[135,0],
        [135,0],[135,0],[135,0],[137,0],[5,0],[122,0],[59,0],[123,0],[123,0],[7,0],
        [59,0],[138,0],[6,0],[37,0],[101,0],[110,0],[110,0],[92,0],[92,0],[57,0],
        [78,0],[103,0],[51,0],[48,0],[48,0],[125,0],[54,0],[50,0],[107,0],[140,0],
        [141,0],[142,0],[93,0],[46,0],[143,0],[144,0],[15,0],[15,0],[140,0],[146,0],
        [124,0],[147,0],[148,0],
      ];
      for (let ni = 0; ni < this.area.npcs.length; ni++) {
        const npc = this.area.npcs[ni];
        const kind = npc.kind;
        if (kind >= CChrPrm.length) continue;
        const chrH = CChrPrm[kind][0];
        const chrL = CChrPrm[kind][1];
        if (chrH < 0) continue; // Negative = invisible/special NPC
        const modelIdx = chrH + chrL + 55;
        if (modelIdx < 0 || modelIdx >= this.models.length) continue;
        const model = this.models[modelIdx];
        if (!model || model.vertices.length === 0) continue;
