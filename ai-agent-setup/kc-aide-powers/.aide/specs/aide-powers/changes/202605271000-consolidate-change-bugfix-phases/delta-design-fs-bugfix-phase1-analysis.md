# 新スキル詳細設計: fs-bugfix-phase1-analysis

> このファイルは delta-design.md の付属設計書。新スキル `fs-bugfix-phase1-analysis` の SKILL.md を実装するための完全仕様。

## スキルファイル配置

- パス: `skills/fs-bugfix-phase1-analysis/SKILL.md`
- frontmatter:
...
- 配置するプロンプトテンプレート（同ディレクトリ）:
  ...
  - `bugfix-plan-reviewer-prompt.md`

**プロンプトテンプレート全文:** [delta-design-fs-bugfix-phase1-prompts.md](./delta-design-fs-bugfix-phase1-prompts.md) を参照
...
5. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `前処理`, step_title: `前処理`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step1`, step_title: `作業ディレクトリの準備`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step2`, step_title: `バグ報告ヒアリング`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step3`, step_title: `バグ報告のユーザー承認`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step4`, step_title: `設計書ゲート`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step5`, step_title: `原因分析`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step6`, step_title: `原因分析のユーザー承認`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step7`, step_title: `フォルダ統合判定`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step8`, step_title: `修正方針の作成`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step9`, step_title: `修正方針のレビュー`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `step10`, step_title: `修正方針のユーザー承認`）
...
5. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase1-analysis`, step_id: `後処理`, step_title: `後処理`）
...
→ [delta-design-fs-bugfix-phase1-prompts.md](./delta-design-fs-bugfix-phase1-prompts.md)
