# 新スキル詳細設計: fs-bugfix-phase2-impl

> このファイルは delta-design.md の付属設計書。新スキル `fs-bugfix-phase2-impl` の SKILL.md を実装するための完全仕様。

## スキルファイル配置

- パス: `skills/fs-bugfix-phase2-impl/SKILL.md`
- frontmatter:
...
5. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `前処理`, step_title: `前処理`）
...
5. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step1`, step_title: `設計系共通スキル呼び出し判定`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step2`, step_title: `修正設計の作成`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step3`, step_title: `修正設計のユーザー承認`）
...
3. 戻り値による分岐:
   - **APPROVED** → Step 6 へ
   - **REJECTED** → Step 5 へ
4. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step4`, step_title: `修正設計のQAレビュー`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step5`, step_title: `QA REJECTED 修正ループ`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step6`, step_title: `差分タスクリストの作成`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step7`, step_title: `タスクリストのユーザー承認`）
...
4. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step8`, step_title: `工程チェック表存在確認 HARD-GATE`）
...
7. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step9`, step_title: `実行計画策定`）
...
6. タスク完了 → 次のタスクへ
7. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step10`, step_title: `タスク実装ループ`）
...
4. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step11`, step_title: `レビュー結果受領後の判断フロー`）
...
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step12`, step_title: `リグレッションテスト`）
...
2. 動作検証を依頼する。伝える内容:
   ...
   - 影響がある既存機能
3. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step13`, step_title: `ユーザー動作検証依頼`）
...
**Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step14`, step_title: `設計書反映`）
...
4. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step15`, step_title: `pending-issues 書き込み忘れチェック`）
...
6. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `step16`, step_title: `バグ修正完了の案内`）
...
5. **Step後処理:** step-history-writer (aide-powers skill) を activate して実行する（skill_name: `fs-bugfix-phase2-impl`, step_id: `後処理`, step_title: `後処理`）
